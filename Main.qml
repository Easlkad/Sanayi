            ...
            SearchBar{
                ...
                onSearchTriggered:{
                    if(searchText.length === 0){
                        ...
                        //transactionModel.search(searchText,Qt.formatDate(startDatePicker.selectedDate, "dd.MM.yyyy"),Qt.formatDate(endDatePicker.selectedDate, "dd.MM.yyyy"))
        ...
        Rectangle{
            ...
            RowLayout{
                ...
                ModernButton{
                    ...
                    onClicked:{
                        let start = Qt.formatDate(startDatePicker.selectedDate,"dd.MM.yyyy")
                        let end = Qt.formatDate(endDatePicker.selectedDate,"dd.MM.yyyy")
                        //transactionModel.filterByDateRange(start,end)
                        transactionModel.search(searchBar.searchText,start,end)
                    }
                }
